<!doctype html>
			<html lang="en">
			  <head>
				...
				<link rel="icon" href="https://saint-lukes.com/wp-content/uploads/2020/08/Asset-13.png">
			  ...
			  <body>
				  ...
				  <h1 class="container mt-4">All Items.</h1>
				  <div class="container bg-light mt-4 border">
					<?php while($row = $result->fetch_assoc()) { ?>
							<div class="container bg-white mt-4 p-4 border">
								<h3><a href="uploads/<?= $row['file'] ?>"><?= $row['title'];?></a></h3>
				  				  <div class="row mt-3">
									<div class="col-lg mt-1">
										<div class="text-muted">Composer</div>
										<div><?= $row['composer'];?></div>
									  </div>
									<div class="col-lg mt-1">
									...
									<div class="col-lg mt-1">
										<div class="text-muted">Rights</div>
										<div><?= $row['rights'];?></div>
									  </div>
									<div class="col-lg mt-1">
										<div class="text-muted">Call No.</div>
										<div><?= $row['call_no'];?></div>
									  </div>
								  </div>
				  			</div>

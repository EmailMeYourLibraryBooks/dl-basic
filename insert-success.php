...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5 alert alert-success" role="alert"> The record was successfuly added. <a href="index.php">Click here to go home</a>, or <a href="insert.php">click here to add another record.</a> </div>
